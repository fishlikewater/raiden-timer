...
public abstract class StringUtils {
     ...
     * e.g. {@code "path/file.txt" -> "file.txt"}.
     *
        ...
        for (int i = 0; i < localePart.length(); i++) {
            ...
            if (ch != ' ' && ch != '_' && ch != '#' && !Character.isLetterOrDigit(ch)) {
                throw new IllegalArgumentException(
                        STR."Locale part \"\{localePart}\" contains invalid characters");
            }
        }
    }
    ...
    public static String toLanguageTag(Locale locale) {
        return STR."\{locale.getLanguage()}\{hasText(locale.getCountry()) ? STR."-\{locale.getCountry()}" : ""}";
    }
    ...
    public static TimeZone parseTimeZoneString(String timeZoneString) {
        ...
        if ("GMT".equals(timeZone.getID()) && !timeZoneString.startsWith("GMT")) {
            ...
            throw new IllegalArgumentException(STR."Invalid time zone specification '\{timeZoneString}'");
        }
        return timeZone;
    }
